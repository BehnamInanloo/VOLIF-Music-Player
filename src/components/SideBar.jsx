...
const SideBar = () => {
  ...
  const favSongsActivation = () => {
    setActiveFavList(true)
  }

  // useContext initializing
  const { setMainHeight, setActiveFavList, setActiveFavSong } = useContext(myContext)
  ...
  useEffect(() => {
    setTimeout(mainHeightHandler, 1500)
  }, [])
